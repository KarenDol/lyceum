          ...
          <div>
            <Link href="/" className="flex items-center mb-4">
              <div className="relative h-12 w-12 mr-3">
                <Image src="/images/logo.png" alt="Лицей Ақбөбек" fill className="object-contain" />
              </div>
              <div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">+7 (777) 123-45-67</span>
              </li>
              <li className="flex items-start">
              ...
              <li className="flex items-start">
                ...
                <span className="text-gray-400">г. Алматы, ул. Примерная, 123</span>
              </li>
              <li className="flex items-start">
